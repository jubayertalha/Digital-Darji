...
public class UploadPortfolioActivity extends AppCompatActivity {
    ...
    String email, name, category, price = "0", img, selectedImg = "", id, todo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        relative_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!todo.equals("delete")) {
                    if (ContextCompat.checkSelfPermission(UploadPortfolioActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE)
        ...
        cv_cancel_uploadSales.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(UploadPortfolioActivity.this, PortfolioActivity.class));
                finish();
            }
        });
        ...
        if (todo.equals("edit")) {
            toolbar_title.setText("Edit Portfolio");
            ...
            toolbar_title.setText("Delete Portfolio");
    ...
    private void delete() {
        ...
        call.enqueue(new Callback<Response>() {
            ...
            public void onResponse(Call<Response> call, retrofit2.Response<Response> response) {
                Toast.makeText(UploadPortfolioActivity.this, "Deleted successfully!", Toast.LENGTH_SHORT).show();
                dialog.cancel();
                startActivity(new Intent(UploadPortfolioActivity.this, PortfolioActivity.class));
                finish();
            }
            ...
            call.enqueue(new Callback<Response>() {
                ...
                public void onResponse(Call<Response> call, retrofit2.Response<Response> response) {
                    if (response.isSuccessful()){
                        Toast.makeText(UploadPortfolioActivity.this, "Updated successfully!", Toast.LENGTH_SHORT).show();
                        dialog.cancel();
                        startActivity(new Intent(UploadPortfolioActivity.this, PortfolioActivity.class));
                        finish();
                    }else {
    ...
    private void upload() {
        ...
        if (!selectedImg.isEmpty() && !name.isEmpty() && !price.isEmpty()) {
            ...
            call.enqueue(new Callback<Response>() {
                ...
                public void onResponse(Call<Response> call, retrofit2.Response<Response> response) {
                    if (response.isSuccessful()){
                        Toast.makeText(UploadPortfolioActivity.this, "Uploaded successfully!", Toast.LENGTH_SHORT).show();
                        dialog.cancel();
                        startActivity(new Intent(UploadPortfolioActivity.this, PortfolioActivity.class));
                        finish();
                    }else {
