...
import com.appincubator.digitaldarji.Adapter.TailorPagerAdapter;
                    ...
                    public void onClick(View v) {
                        ...
                        call.enqueue(new Callback<Response>() {
                            ...
                            public void onResponse(Call<Response> call, retrofit2.Response<Response> response) {
                                ...
                                Call<com.appincubator.digitaldarji.Model.Response> call1 = api.addNotificationResponse("ADD",email,msg,"ITEM");
