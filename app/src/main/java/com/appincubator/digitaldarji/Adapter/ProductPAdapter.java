...
import com.appincubator.digitaldarji.Activity.UploadPortfolioActivity;

public class ProductPAdapter extends ArrayAdapter<Product> {
    Activity context;
    ArrayList<Product> products;

    ImageView iv_delete,iv_edit;

    public ProductPAdapter(Activity context, ArrayList<Product> objects) {
        super(context, R.layout.item_portfolio, objects);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View view = inflater.inflate(R.layout.item_portfolio,null,true);
    ...
    public void delete(int position){
        ...
        Intent intent = new Intent(context,UploadPortfolioActivity.class);
